 ...
 */
 ...
 pub fn idct_wasm(in_vector: &mut [i32; 64], out_vector: &mut [i16], stride: usize) {
     unsafe {
         ...
         // it
         idct_int_wasm_inner(in_vector, out_vector, stride);
     }
 }
 ...
 pub unsafe fn idct_int_wasm_inner(
